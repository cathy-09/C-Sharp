namespace Recursion_Tutorial
{
    partial class Minimum_element
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonClearMinElement = new Button();
            SuspendLayout();
            // 
            ...
            buttonMinimumElementResult.Location = new Point(356, 75);
            ...
            // 
            // buttonClearMinElement
            // 
            buttonClearMinElement.BackColor = Color.Thistle;
            buttonClearMinElement.Font = new Font("Corbel", 12F, FontStyle.Bold, GraphicsUnit.Point);
            buttonClearMinElement.Location = new Point(259, 75);
            buttonClearMinElement.Name = "buttonClearMinElement";
            buttonClearMinElement.Size = new Size(91, 27);
            buttonClearMinElement.TabIndex = 5;
            buttonClearMinElement.Text = "Clear";
            buttonClearMinElement.UseVisualStyleBackColor = false;
            buttonClearMinElement.Click += buttonClearMinElement_Click;
            // 
            // Minimum_element
            // 
            ...
            Controls.Add(buttonClearMinElement);
        ...
        private Button buttonClearMinElement;
    }
}