namespace Recursion_Tutorial
{
    partial class Sum_of_an_array_sequence
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonClearSumArray = new Button();
            SuspendLayout();
            // 
            // labelArraySequence
            // 
            ...
            // buttonClearSumArray
            // 
            buttonClearSumArray.BackColor = Color.Thistle;
            buttonClearSumArray.Font = new Font("Corbel", 12F, FontStyle.Bold, GraphicsUnit.Point);
            buttonClearSumArray.Location = new Point(290, 89);
            buttonClearSumArray.Name = "buttonClearSumArray";
            buttonClearSumArray.Size = new Size(84, 28);
            buttonClearSumArray.TabIndex = 5;
            buttonClearSumArray.Text = "Clear";
            buttonClearSumArray.UseVisualStyleBackColor = false;
            buttonClearSumArray.Click += buttonClearSumArray_Click;
            // 
            ...
            Controls.Add(buttonClearSumArray);
        ...
        private Button buttonClearSumArray;
    }
}