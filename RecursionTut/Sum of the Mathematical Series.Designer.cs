namespace Recursion_Tutorial
{
    partial class Sum_of_the_Mathematical_Series
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Sum_of_the_Mathematical_Series));
            ...
            buttonClearMathSequ = new Button();
            SuspendLayout();
            // 
            // labelMathSeries
            // 
            ...
            // buttonClearMathSequ
            // 
            buttonClearMathSequ.BackColor = Color.Thistle;
            buttonClearMathSequ.Font = new Font("Corbel", 12F, FontStyle.Bold, GraphicsUnit.Point);
            buttonClearMathSequ.Location = new Point(293, 102);
            buttonClearMathSequ.Name = "buttonClearMathSequ";
            buttonClearMathSequ.Size = new Size(75, 31);
            buttonClearMathSequ.TabIndex = 8;
            buttonClearMathSequ.Text = "Clear";
            buttonClearMathSequ.UseVisualStyleBackColor = false;
            buttonClearMathSequ.Click += buttonClearMathSequ_Click;
            // 
            ...
            Controls.Add(buttonClearMathSequ);
        ...
        private Button buttonClearMathSequ;
    }
}